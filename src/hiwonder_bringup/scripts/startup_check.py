...
if __name__ == '__main__':
    ...
    from ros_robot_controller import ros_robot_controller_sdk
    ...
    board = ros_robot_controller_sdk.Board()
    board.set_oled_text(1, 'SSID:' + get_cpu_serial_number())
    board.set_oled_text(2, 'IP:' + get_wlan())
